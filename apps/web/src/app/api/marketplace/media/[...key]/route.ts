...
// S3ProfileMediaStorage), então não dá pra enumerar/adivinhar — a mesma lógica de "link não
// listado" usada pela rota equivalente de imóveis (GET /api/properties/media/[...key]).
