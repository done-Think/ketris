...
export const ownerDashboardNavigationItems: OwnerNavigationItem[] = [
  ...
  { id: 'properties', label: 'Meus Imóveis', href: '/dashboard/imoveis' },
  { id: 'proposals', label: 'Propostas', href: '/dashboard/propostas' },
  { id: 'visits', label: 'Visitas', href: '/dashboard/agenda' },
  { id: 'financial', label: 'Financeiro', href: '/dashboard/financeiro' },
