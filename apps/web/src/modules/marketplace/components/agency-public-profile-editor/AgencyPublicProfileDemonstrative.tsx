...
import type { AgencyPublicProfileDemonstrativeProps } from '../../types/agency-public-profile-editor'
import { agencySectionIcons, getAgencySectionOption } from './agency-public-profile-editor-shared'
import { AgencyPublicProfileMiniSection } from './AgencyPublicProfilePreviewSections'

export function AgencyPublicProfileDemonstrative({
  draggedPosition,
  finishLongPress,
  isTouchLikeDevice,
  moveLongPress,
  ...
  visibleSectionOrder,
}: AgencyPublicProfileDemonstrativeProps) {
        ...
        {visibleSectionOrder.length > 0 ? (
          <Stack spacing={1.6}>
            {visibleSectionOrder.map((sectionKey) => {
              ...
              const Icon = agencySectionIcons[sectionKey]
              ...
              return (
                <Box
                  ...
                  sx={{
                    ...
                    '@keyframes agencyLongPressProgress': {
                      from: { transform: 'scaleX(0)' },
                      to: { transform: 'scaleX(1)' },
                    },
                    '&::after': pressed
                      ? {
                          animation: 'agencyLongPressProgress 2s linear forwards',
                  ...
                  <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 0.9 }}>
                    <Stack
                      ...
                      sx={{
                        ...
                        userSelect: 'none',
                        zIndex: 3,
                        '@keyframes agencyPositionPillPulse': {
                          '0%, 100%': {
                        ...
                        ...(isTouchLikeDevice
                          ? { animation: 'agencyPositionPillPulse 1.8s ease-in-out infinite' }
                          : {}),
                      }}
