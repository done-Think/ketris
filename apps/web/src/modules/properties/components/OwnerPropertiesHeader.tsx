...
export function OwnerPropertiesHeader({ filters, onFiltersChange }: OwnerPropertiesHeaderProps) {
  ...
  return (
    <Box sx={{ mb: 4 }}>
          ...
          <TextField
            ...
            slotProps={{
              select: {
                ...
                renderValue: (value) =>
                  `Status: ${{ all: 'Todos', active: 'Ativo', paused: 'Pausado' }[value as OwnerPropertyStatusFilter]}`,
              },
            }}
            sx={controlSx}
          >
      ...
      <Typography
        sx={{ mt: 4, color: brand.neutral[500], fontSize: 12, fontWeight: 500, lineHeight: 1.6 }}
      >
